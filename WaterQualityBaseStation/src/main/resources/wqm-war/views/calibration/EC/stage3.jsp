...
<jsp:attribute name="head">
    ...
    <jsp:body>
        <div id="calibrate_content" class="span5">
            <H3>${station.getCommonName()} EC Calibration ${kSelected} - Low Side Calibration - ${ecLow}µs/cm</H3>
            <P>Place the ${kSelected} EC probe into the ${ecLow}µs/cm and when the graph has stabilized press the accept button below.</P>
